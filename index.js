...
const vcard = 'BEGIN:VCARD\n' //jangan ganti Sayang
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6289617326245:+6289617326245\n'  //ganti nomor kamu sayang
...
lolkey = 'f8749f1897749e55c68f6198' //apiknya ya sayang
/******** OWNER NUMBER**********/

const ownerNumber = ["6289617326245@s.whatsapp.net"]   //ganti nomor kamu sayang
	...
	client.on('message-new', async (mek) => {
		...
		try {
			...
			const groupAdmins = isGroup ? getGroupAdmins(groupMembers) : ''
           	const ftoko = { key: { fromMe: false, participant: `6289617326245@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./src/logobot.jpg') }, "title": `Subrek ItsAra`, "productImageCount": 9999 }, "businessOwnerJid": `6289617326245@s.whatsapp.net`}}}
...
│❀ OWNER : https://wa.me/6289617326245
...
break
		...
		case 'lpr':
					...
					client.sendMessage('6289617326245@s.whatsapp.net', options, text, {quoted: mek})
		...
		case 'request':
					...
					client.sendMessage('6289617326245@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6289617326245@s.whatsapp.net', options, text, {quoted: mek})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER RK REQUESTS PALSU ATAU MAIN² TIDAK AKAN DITANGGAPI.')
					break
		case 'blocklist': 
...
if (args.length == 0) return reply(`Idnya mana kak?`)
                    ff_id = args[0]
                    get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/freefire/${ff_id}?apikey=f8749f1897749e55c68f6198`)
...
//MAKERMENU
		...
		if (!isRegistered) return reply(ind.noregis())
                    ...
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/textprome/${command}?apikey=f8749f1897749e55c68f6198&text=${ini_txt}`)
		...
		if (!isRegistered) return reply(ind.noregis())
               cf = `${body.slice(8)}`
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/textprome2/${command}?apikey=f8749f1897749e55c68f6198&text1=${txt1}&text2=${txt2}`)
		...
		if (!isRegistered) return reply(ind.noregis())
                    if (args.length == 0) return reply(`Example: ${prefix + command} Its Ara`)
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/photooxy1/${command}?apikey=f8749f1897749e55c68f6198&text=${ini_txt}`)
                    client.sendMessage(from, ini_buffer, image, { quoted: mek})
                    break
                case 'tiktok':
                case 'arcade8bit':
		...
		if (!isRegistered) return reply(ind.noregis())
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/photooxy2/${command}?apikey=f8749f1897749e55c68f6198&text1=${txt1}&text2=${txt2}`)
                    client.sendMessage(from, ini_buffer, image, { quoted: mek})
                    break
		...
		if (!isRegistered) return reply(ind.noregis())
                    if (args.length == 0) return reply(`Example: ${prefix + command} Its Ara`)
                    ini_txt = args.join(" ")
                    ini_buffer = await getBuffer(`http://api.lolhuman.xyz/api/ephoto1/${command}?apikey=f8749f1897749e55c68f6198&text=${ini_txt}`)
                    client.sendMessage(from, ini_buffer, image, { quoted: mek})
                    break
                   case 'ytkomen':
		if (!isRegistered) return reply(ind.noregis())
		...
		username = args[0]
		comment = args[2]
                    buffer = await getBuffer(`http://lolhuman.herokuapp.com/api/ytcomment?apikey=f8749f1897749e55c68f6198&username=${username}&comment=${comment}&img=https://i.ibb.co/JdfQ73m/photo-2021-02-05-10-13-39.jpg`)
		...
		username = args[0]
		comment = args[2]
                    buffer = await getBuffer(`http://api.lolhuman.xyz/api/phcomment?apikey=f8749f1897749e55c68f6198&img=https://i.ibb.co/JdfQ73m/photo-2021-02-05-10-13-39.jpg&text=${comment}&username=${username}`)
                    client.sendMessage(from, buffer, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "*Subscribe Akira*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('akiraganz/fake.jpg')} } }, caption: 'Nih Hasilnya Kak...'})
                    break
                    case 'amongus':
		if (!isRegistered) return reply(ind.noregis())
                    if (args.length == 0) return reply(`Usage: ${prefix + command} query\nContoh: ${prefix + command} Fernazer`)
                    buffer = await getBuffer(`http://lolhuman.herokuapp.com/api/amongus?apikey=f8749f1897749e55c68f6198&text=${body.slice(9)}`)
                    client.sendMessage(from, buffer, sticker, { quoted: mek})
                    break
                    case 'artinama':
		if (!isRegistered) return reply(ind.noregis())
                    ...
                    ini_nama = args.join(" ")
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/artinama?apikey=f8749f1897749e55c68f6198&nama=${ini_nama}`)
                    reply(get_result.result)
                    break
                case 'jodoh':
		if (!isRegistered) return reply(ind.noregis())
                    ...
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/jodoh/${nama1}/${nama2}?apikey=f8749f1897749e55c68f6198`)
		...
		if (!isRegistered) return reply(ind.noregis())
                    ...
                    bulan = args[1]
                    tahun = args[2]
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/weton/${tanggal}/${bulan}/${tahun}?apikey=f8749f1897749e55c68f6198`)
                    get_result = get_result.result
		...
		if (!isRegistered) return reply(ind.noregis())
                    ...
                    bulan = args[1]
                    tahun = args[2]
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/jadian/${tanggal}/${bulan}/${tahun}?apikey=f8749f1897749e55c68f6198`)
                    get_result = get_result.result
		...
		if (!isRegistered) return reply(ind.noregis())
                    ...
                    ini_name = args.join(" ")
                    if (args.length == 0) return reply(`Contoh: ${prefix + command} Fernazer`)
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/tebakumur?apikey=f8749f1897749e55c68f6198&name=${ini_name}`)
                    get_result = get_result.result
               ...
               case 'alay': 
				...
				if (args.length < 1) return reply(`Contoh: Fernazer`)
					...
					anu = await fetchJson(`http://api.lolhuman.xyz/api/alay?apikey=f8749f1897749e55c68f6198&text=${gatauda}`)
					reply(anu.result)
					break
					case 'purba':
					case 'bpurba': 
				...
				if (args.length < 1) return reply(`Contoh: Fernazer`)
					...
					anu = await fetchJson(`http://api.lolhuman.xyz/api/bahasapurba?apikey=f8749f1897749e55c68f6198&text=${gatauda}`)
					reply(anu.result)
					break
					case 'BK':
					case 'bk':
				...
				if (args.length < 1) return reply(`Contoh: Fernazer`)
					...
					anu = await fetchJson(`http://api.lolhuman.xyz/api/upperlower?apikey=f8749f1897749e55c68f6198&text=${gatauda}`)
					reply(anu.result)
					break
					case 'hilih': 
				if (!isRegistered) return reply(ind.noregis())
				if (args.length < 1) return reply(`Contoh: Fernazer`)
					gatauda = body.slice(7)
					anu = await fetchJson(`http://api.lolhuman.xyz/api/hilih?apikey=f8749f1897749e55c68f6198&text=${gatauda}`)
					reply(anu.result)
					break
               case 'namaninja': 
				if (!isRegistered) return reply(ind.noregis())
				if (args.length < 1) return reply(`Contoh: Fernazer`)
					...
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/ninja?apikey=f8749f1897749e55c68f6198&nama=${gatauda}`)
					reply(anu.result)
					break
                   case 'tebakbendera':
					anu = await fetchJson(`http://lolhuman.herokuapp.com/api/tebak/bendera?apikey=f8749f1897749e55c68f6198`, {method: 'get'})
                ...
                case 'githubstalk':
                    ...
                    username = args[0]
                    ini_result = await fetchJson(`https://api.lolhuman.xyz/api/github/${username}?apikey=f8749f1897749e55c68f6198`)
...
//BATES NGAB STALKING MENU
                   case 'igstalk':
					if (!isRegistered) return reply(ind.noregis())
					get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/stalkig/${body.slice(9)}?apikey=f8749f1897749e55c68f6198`, {method: 'get'})
					get_result = get_result.result
		        	...
		        	if (!isRegistered) return reply(ind.noregis())
		        	username = args[0]
					get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/stalktiktok/${username}?apikey=f8749f1897749e55c68f6198`, {method: 'get'})
					get_result = get_result.result
					...
					if (!isRegistered) return reply(ind.noregis())
					ytk = `${body.slice(11)}`
					anu = await fetchJson(`https://api.lolhuman.xyz/api/ytchannel?apikey=f8749f1897749e55c68f6198&query=${ytk}`, {method: 'get'})
					cari = '•••••••••••••••••\n'
...
//SEARCH MENU
                case 'googleimage':
                    if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    if (!isRegistered) return reply( ind.noregis()) 
                    if (args.length == 0) return reply(`Example: ${prefix + command} Kodok`)
                    reply(ind.wait())
                    query = args.join(" ")
                    imag = body.slice(13)
                    asu = await fetchJson(`https://api.lolhuman.xyz/api/gimage?apikey=f8749f1897749e55c68f6198&query=${imag}`)
                    teks = '=================\n'
                    ...
                    case 'animesearch':
                    if (!isRegistered) return reply(ind.noregis())
                    if (args.length == 0) return reply(`Example: ${prefix + command} Akame Ga Kill`)
                    query = args.join(" ")
                    anim = body.slice(13)
                    anu = await fetchJson(`https://api.lolhuman.xyz/api/anime?apikey=f8749f1897749e55c68f6198&query=${anim}`)
                				teks = '=================\n'
                    ...
                    case 'brainly':
                    if (!isRegistered) return reply(ind.noregis())
                    if (args.length == 0) return reply(`Example: ${prefix + command} pada tahun kapan Indonesia merdeka?`)
                    query = args.join(" ")
                    brien = body.slice(8)
                    ...
                    console.log(res)})
		                		...
		                		case 'translate':
                    if (!isRegistered) return reply(ind.noregis())
                    if (args.length == 0) return reply(`Example: ${prefix + command} what is your name?`)
                    query = args.join(" ")
                    ct = body.slice(11)
                    asu = await fetchJson(`https://api.lolhuman.xyz/api/translate/auto/id?apikey=f8749f1897749e55c68f6198&query=${ct}`)
                    rk = `English : ${ct}\nIndonesia : ${asu.result.text}`
                    client.sendMessage(from, rk, text, {quoted: mek})
                    await limitAdd(sender)
                    break
//DOWNLOAD MENU
                    case 'ytplay':
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytplay?apikey=f8749f1897749e55c68f6198&query=${query}`)
                    get_result = get_result.result
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} Dj Tie Me Down`)
                    query = args.join(" ")
                    get_result = await fetchJson(`http://api.lolhuman.xyz/api/ytplay2?apikey=f8749f1897749e55c68f6198&query=${query}`)
                    get_result = get_result.result
                    ...
                    ini_link = args[0]
                    get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/ytaudio2?apikey=f8749f1897749e55c68f6198&url=${ini_link}`)
                    get_result = get_result.result
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} Dj Tie Me Down`)
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytsearch?apikey=f8749f1897749e55c68f6198&query=${query}`)
                    get_result = get_result.result
                    ini_txt = ""
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytaudio?apikey=f8749f1897749e55c68f6198&url=${ini_link}`)
                    get_result = get_result.result
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytaudio2?apikey=f8749f1897749e55c68f6198&url=${ini_link}`)
                    get_result = get_result.result
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytvideo?apikey=f8749f1897749e55c68f6198&url=${ini_link}`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Uploader : ${get_result.uploader}\n`
                    ini_txt += `Duration : ${get_result.duration}\n`
                    ...
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.youtube.com/watch?v=qZIQAk-BUEc`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ytvideo2?apikey=f8749f1897749e55c68f6198&url=${ini_link}`)
                    get_result = get_result.result
                    ini_txt = `${get_result.title} - ${get_result.size}`
                    ini_buffer = await getBuffer(get_result.thumbnail)
                    ...
                    case 'facebook':
                    if (!isRegistered) return reply(ind.noregis())
                    if (args.length == 0) return reply(`Example: ${prefix + command} https://www.facebook.com/100000064355559/posts/6726778670667545/?app=fbl`)
                    ini_link = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/facebook?apikey=f8749f1897749e55c68f6198&url=${ini_link}`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Uploader : ${get_result.uploader}\n`
                    ini_txt += `Duration : ${get_result.duration}\n`
		...
		if (budy.includes(`6289617326245`)) {
                  reply(`Jangan Tag Owner Ku`)
